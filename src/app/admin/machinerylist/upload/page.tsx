...
const MachineryUpload = () => {
  ...
  const [machineryImages, setMachineryImages] = useState<File[]>([]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!machineryName || !brandName|| machineryImages.length === 0) {
    ...
    try {
      ...
      machineryImages.forEach((file) => formData.append('machineryImage', file));
