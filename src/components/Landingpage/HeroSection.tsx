      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-12 flex flex-col lg:flex-row items-center gap-8 md:gap-14 relative z-10">
        ...
        >
          ...
          <p className="mt-2 text-justify md:text-base text-[#e5e5e5] max-w-2xl mx-auto lg:mx-0 lg:text-left">
            We deliver high-quality, reliable engineered components for
            automotive and industrial applications, ensuring performance,
            durability, and safety in critical systems like brakes, engines, and
            machinery.
          </p>
        ...
        <motion.div className="flex-1 grid grid-cols-3 gap-2 md:gap-5 order-1">
          ...
          >
            <Image
              src={image1}
              alt="Precision Component 1"
              className="rounded-lg shadow-2xl object-cover w-full h-full border-4 border-[#e5e5e5]"
            />
          </motion.div>
          ...
          >
            <Image
              src={image5}
              alt="Precision Component 4"
              className="rounded-lg shadow-2xl object-cover w-full h-40 border-4 border-[#e5e5e5]"
            />
          </motion.div>
        </motion.div>
      </div>
