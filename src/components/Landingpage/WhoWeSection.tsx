      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mt-5 md:mt-16 flex flex-wrap justify-center gap-5 lg:gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="rounded-xl md:rounded-full w-36 md:h-40 md:w-40 xl:w-52 xl:h-52 flex flex-col items-center justify-center gap-4 p-2 bg-white shadow-md md:-rotate-45">
