    ...
    <section className="relative py-20 overflow-hidden bg-[#205057] ">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-semibold  font-sans text-white  leading-tight">
            Our Clients
          </h2>
          <div className="w-24 h-1 mx-auto bg-white rounded-full mb-6"></div>

          <p className=" md:text-lg text-[#e5e5e5] max-w-2xl mx-auto leading-relaxed">
            We're proud to work with forward-thinking companies that trust us to
            deliver exceptional results and drive innovation in their
            industries.
          </p>
        </div>
        {clients.length > 4 ? (
